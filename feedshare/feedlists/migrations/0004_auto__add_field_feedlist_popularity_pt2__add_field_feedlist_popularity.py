...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FeedList.popularity_hn'
        db.add_column(u'feedlists_feedlist', 'popularity_hn',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'FeedList.popularity_hn'
        db.delete_column(u'feedlists_feedlist', 'popularity_hn')
